...
Der Standardbrowser wird [https://localhost:3000/](https://localhost:3000) mit einer standardmäßigen reaktionsseite geöffnet. Wenn Ihr Browser nicht geöffnet wird, öffnen Sie ihn, [https://localhost:3000/](https://localhost:3000) und navigieren Sie zu, um zu überprüfen, ob die neue APP funktioniert.

Bevor Sie fortfahren, sollten Sie einige zusätzliche Pakete installieren, die Sie später verwenden werden:

- [reagiere-Router-Dom](https://github.com/ReactTraining/react-router) für deklaratives Routing innerhalb der Reaktions-app.
...
- [fontawesome](https://github.com/FortAwesome/Font-Awesome) für Symbole.
- [Moment](https://github.com/moment/moment) für das Formatieren von Datums-und Uhrzeitangaben.
- [msal](https://github.com/AzureAD/microsoft-authentication-library-for-js) für die Authentifizierung bei Azure Active Directory und das Abrufen von Zugriffstoken.
...
Erstellen Sie als nächstes eine Homepage für die app. Erstellen Sie eine neue Datei im `./src` Verzeichnis mit `Welcome.js` dem Namen, und fügen Sie den folgenden Code hinzu.
...
Erstellen Sie nun eine Fehlermeldung, um Nachrichten für den Benutzer anzuzeigen. Erstellen Sie eine neue Datei im `./src` Verzeichnis mit `ErrorMessage.js` dem Namen, und fügen Sie den folgenden Code hinzu.
...
Aktualisieren Sie nun mit diesen grundlegenden Komponenten die APP, um Sie zu verwenden. Öffnen Sie zunächst die `./src/index.css` Datei, und ersetzen Sie den gesamten Inhalt durch Folgendes.
...
Als nächstes öffnen `./src/App.js` und ersetzen Sie den gesamten Inhalt durch Folgendes.
